...
struct TrackNode {
    ...
    bool isExpressPassing = false; // Express train approaching Lv1 stop at speed
...
public:
    ...
    void UpdateStationPIDS(float leadTrainDist, const std::vector<float>& extraTrainDists, float trainSpeed, bool isLeadExpress = false);
